...
namespace Aircraft
{
    public class AircraftArea : MonoBehaviour
    {
        ...
        /// <summary>
        /// Actions to perform when the script wake up
        /// </summary>
        private void Awake()
        {
        ...
        private void CreateCheckpoints()
        {
            ...
            {
                // Intsantiate either a checkpoint or finish line checkpoint
        ...
        public void ResetAgentPosition(AircraftAgent agent, bool randomize = false)
        {
            ...
            // Get teh orientatio at that position on the race path
            ...
            // Set he aircraft position and rotation
