...
namespace Aircraft
{
    public class AircraftAgent : Agent
    {
        ...
        [Tooltip("The game object of the explosio particle effect")]
        ...
        //Whether the aircraft is frozen (intentionnally not flying)
        ...
        public override void OnActionReceived(ActionBuffers actions)
        {
            ...
            if (area.trainingMode)
            {
                ...
                // Make sure we haven't run out of time if traning
        ...
        /// <summary>
        ///  Collects observations usedby agent to make decisions
        /// </summary>
        ...
        public override void CollectObservations(VectorSensor sensor)
        {
            ...
            // Orientation of the next next checkpoint (1 Vector3 = 3 values)
        ...
        {
            Debug.LogError("Heuristic() was calles on" + gameObject.name +
